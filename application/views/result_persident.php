...
<body>
    <!--Navbar--> <?php
            ...
            <div class='card'>
                ...
                <div class='card-body'>
                    <h2 class='mb-3'><i class="fa fa-list-alt"></i> ผลประเมินของท่าน</h2>
                    ...
                    <br>
                    <hr>
                    <h2 class='mb-3'><i class="fa fa-list-alt"></i> ผลประเมินในสาขา</h2>
                    <div class="table-responsive">
                        <table class="table table-striped text-center" border="1" id='tb_t'>
                            ...
                            <tbody> <?php
                                    foreach ($data_affiliated_agencies as $key => $value) {
                                        # code...
                                    ...
                                    ?> <tr>
                                        ...
                                        <th scope="row"><?php
                                                        ...
                                                        ?></th>
                                        <th scope="row"><?= $value['total_score_p'] + $value['total_score_c'] ?></th>
                                        <td> <a id="result2" id-result="<?= $value['id'] ?>">
                                                <span class="fa fa-arrow-right"></span>
                                            </a>
                                        </td>
                                    </tr> <?php
